...
export default function HeroHomeThree() {
  return (
    <div className="rk-theme-hero-section3 section" style={{ backgroundImage: "url(/assets/images/home3/hero-bg.png)" }}>
      <div className="container">
        <div className="rk-theme-section-title">
          <div className="row">
            <div className="col-lg-7">
              <div className="rk-theme-hero-content3" data-aos="fade-up" data-aos-delay="500">
                <h1>AI the future of business</h1>
              </div>
            </div>
            <div className="col-lg-5">
              <div className="rk-theme-hero-content3" data-aos="fade-up" data-aos-delay="700">
                ...
                <div className="mt-50">
                  <Link href="/about-us" className="rk-theme-default-btn outline-btn3">Explore About Us</Link>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="rk-theme-hero-thumb3" data-aos="fade-up" data-aos-delay="500">
        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-xl-4 col-md-6">
              <div className="rk-theme-iconbox-wrap4" data-aos="fade-up" data-aos-delay="500">
                <div className="rk-theme-iconbox-icon4">
                  <img src="assets/images/home3/icon2.svg" alt="Icon" />
                </div>
                <div className="rk-theme-iconbox-content4">
            ...
            <div className="col-xl-4 col-md-6">
              <div className="rk-theme-iconbox-wrap4" data-aos="fade-up" data-aos-delay="700">
                <div className="rk-theme-iconbox-icon4">
            ...
            <div className="col-xl-4 col-md-6">
              <div className="rk-theme-iconbox-wrap4 mb-0" data-aos="fade-up" data-aos-delay="900">
                <div className="rk-theme-iconbox-icon4">

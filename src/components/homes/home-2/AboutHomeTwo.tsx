...
export default function AboutHomeTwo() {
  return (
    <>
      <div className="rk-theme-section-padding pt-0">
      ...
      <div className="rk-theme-section-padding pt-0 overflow-hidden">
        <div className="container">
          <div className="row">
            <div className="col-lg-5">
            ...
            <div className="col-lg-7 d-flex align-items-center">
              <div className="rk-theme-default-content content3 pl-110" data-aos="fade-up" data-aos-delay="700">
                ...
                <div className="mt-50" data-aos="fade-up" data-aos-delay="900">
                  <Link className="rk-theme-default-btn btn3" href="/contact-us" data-text="Try It Now">

...
export default function BrandHomeTwo() {
  return (
    <section className="rk-theme-section-padding section" style={{ backgroundImage: 'url(/assets/images/home2/in-bg.png)' }}>
        ...
        <div className="row">
          <div className="col-lg-7 d-flex align-items-center">
            <div className="rk-theme-default-content content2 content3 pr-110" data-aos="fade-up" data-aos-delay="500">
              ...
              <div className="mt-50">
                <Link href="/contact-us" className="rk-theme-default-btn btn2">

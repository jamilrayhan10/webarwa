...
export default function HeroHomeOne() {
  return (
    <div className="rk-theme-hero-section">
      <div className="rk-theme-hero-shape">
        <img src="assets/images/home1/hero-bg.png" alt="bg" />
      </div>
      <div className="container">
        <div className="rk-theme-hero-content1">
          ...
          <div className="rk-theme-hero-button mt-50">
            <Link className="rk-theme-default-btn" data-aos="fade-up" data-aos-delay="900" href="/contact-us" data-text="Get started for free">
              <span className="button-wraper">Get started for free</span>
            </Link>
            <Link className="rk-theme-default-btn outline-btn" data-aos="fade-up" data-aos-delay="1000" href="/contact-us" data-text="Learn more">
              <span className="button-wraper">Learn more</span>
            </Link>
          </div>
        </div>
        <div className="rk-theme-hero-dashboard" data-aos="fade-up" data-aos-delay=".7s">

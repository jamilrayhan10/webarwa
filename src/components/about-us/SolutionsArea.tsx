      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-lg-7 d-flex align-items-center">
            <div className="rk-theme-default-content pr50" data-aos="fade-up" data-aos-delay="700">
              ...
              <div className="mt-50">
                <Link className="rk-theme-default-btn aos-init aos-animate" data-aos="fade-up" data-aos-delay="700" href="/contact-us" data-text="Get in touch">

...
export default function AboutTeam() {
  return (
    <section className="rk-theme-section-padding2">
      <div className="container">
        <div className="rk-theme-section-title two-column" data-aos="fade-right" data-aos-delay="500">
          <div className="row">
            ...
            <div className="col-lg-5 d-flex align-items-center">
              <div className="section-title-button">
                <Link className="rk-theme-default-btn rk-theme-btn" data-aos="fade-right" data-aos-delay="900" href="/team" data-text="Join our team">

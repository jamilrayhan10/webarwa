...
export default function ServiceDetailsArea() {
  return (
    <>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-xl-6 col-lg-7 d-flex align-items-center">
              <div className="rk-theme-default-content" data-aos="fade-up" data-aos-delay="700">
      ...
      <div className="rk-theme-section-pb">
        <div className="container">
          <div className="rk-theme-section-title center max-width-850" data-aos="fade-up" data-aos-delay="500">
          ...
          <div className="row">
            ...
            <div className="col-lg-6 offset-lg-1 d-flex align-items-center">
              <div className="rk-theme-target-list-wrap">
                <div className="rk-theme-target-list" data-aos="fade-up" data-aos-delay="500">
                ...
                <div className="rk-theme-target-list" data-aos="fade-up" data-aos-delay="700">
                ...
                <div className="rk-theme-target-list" data-aos="fade-up" data-aos-delay="900">

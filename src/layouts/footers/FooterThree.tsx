...
export default function FooterThree() {
  return (
    <footer className="rk-theme-section-padding bg-heading">
      <div className="container">
        ...
        <div className="rk-theme-footer-three">
          <div className="rk-theme-footer-textarea textarea3">
            <Link href="/">
          ...
          <div className="rk-theme-footer-three-right">
